...
def load_from_standard_weights(input_file: str, device: str, pre_trained_model: str) -> dict[str, torch.Tensor]:
    ...
    if pass_diff == True:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.1.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.1.1.qkv.weight']
            converted['diffusion']['unet.encoders.1.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.1.1.qkv.bias']
        else:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.2.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.2.1.qkv.weight']
            converted['diffusion']['unet.encoders.2.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.2.1.qkv.bias']
        else:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.4.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.4.1.qkv.weight']
            converted['diffusion']['unet.encoders.4.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.4.1.qkv.bias']
        else:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.5.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.5.1.qkv.weight']
            converted['diffusion']['unet.encoders.5.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.5.1.qkv.bias']
        else:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.7.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.7.1.qkv.weight']
            converted['diffusion']['unet.encoders.7.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.7.1.qkv.bias']
        else:
        ...
        if pre_trained_model == 'tarf':
            converted['diffusion']['unet.encoders.8.1.conv_input.weight'] = original_model['model.diffusion_model.input_blocks.8.1.qkv.weight']
            converted['diffusion']['unet.encoders.8.1.conv_input.bias'] = original_model['model.diffusion_model.input_blocks.8.1.qkv.bias']
        else:
...
def load_model(enc, dec, device, cond=False):
    state_dict = load_from_standard_weights("v1-5-pruned.ckpt", device)
    enc.load_state_dict(state_dict['encoder'], strict=True)
    enc = enc.to(device)
    
    dec.load_state_dict(state_dict['decoder'], strict=True)
    dec = dec.to(device)
